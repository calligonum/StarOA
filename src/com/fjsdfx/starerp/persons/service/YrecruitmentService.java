...
public interface YrecruitmentService extends BaseService<Yrecruitment>{

	//public void ydel(List<Yrecruitment> yrecruitmentTemp,List<Recruitment> recruitmentlist);
}
